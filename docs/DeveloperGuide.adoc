...
The test method will return true for the ReadOnlyperson if either of these methods return true, indicating that at least one keyword matches with one of the 6 attributes.
